function register() {
    ...
    if (name && phn && age && ht && wt && pwd) {
        ...
        if (phn.match(phoneno)) {
            ...
            document.getElementById("reg").innerHTML = ' <div class="lds-ring"><div></div><div></div><div></div><div></div></div> '
...
function login() {
    ...
    var phoneno = /^\d{10}$/;
    if (phn.match(phoneno)) {
        document.getElementById("log").innerHTML = ' <div class="lds-ring"><div></div><div></div><div></div><div></div></div> '
